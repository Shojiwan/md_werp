...
nodes_shape <- shapefile(paste0("C:/001_MD_WERP/002_R/md_werp/r/hs2tfv/004_DATA/",
                         "culgoa_WH_lines_20m_wgs84.shp"))
nodes_shape <- nodes_shape@data


#2345678901234567890123456789012345678901234567890123456789012345678901234567890
# Save object 
data[['model_domain']] <- mesh
data[['nodes_tw']] <- nodes_TW
data[['nodes_sf']] <- nodes_shape
saveRDS(object = data, file = paste0(path, 'supporting_data_20240219.RData'))
